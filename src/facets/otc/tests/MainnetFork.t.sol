...
import { OTCFacet }  from "../OTCFacet.sol";

import { OTCBuffer } from "../OTCBuffer.sol";
...
abstract contract Mainnet_OTC_Tests is MainnetTests {
...
// NOTE: This test requires the send to be executed first which requires `MainnetTests`, therefore
//       it is placed here instead of in the `OTCFacet` integrations tests for the setters.
contract Mainnet_OTC_SetOTCBuffer_Tests is Mainnet_OTC_Tests {
...
contract Mainnet_OTC_Send_Tests is Mainnet_OTC_Tests {
...
contract Mainnet_OTC_Claim_Tests is Mainnet_OTC_Tests {
...
contract Mainnet_OTC_E2ETests is Mainnet_OTC_Tests {
...
contract Mainnet_OTC_GetClaimedWithRecharge_Tests is Mainnet_OTC_Tests {
...
contract Mainnet_OTC_IsSwapReady_Tests is Mainnet_OTC_Tests {
