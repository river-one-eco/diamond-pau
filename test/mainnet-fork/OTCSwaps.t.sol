...
abstract contract OTC_TestBase is ForkTestBase {
    ...
    function setUp() public virtual override {
        ...
        OTCBuffer(otcBuffer).approve(Ethereum.USDT, type(uint256).max);
        OTCBuffer(otcBuffer).approve(Ethereum.USDS, type(uint256).max);
        vm.stopPrank();
        ...
        mainnetController.setOTCBuffer(exchange, otcBuffer);
...
contract MainnetController_OTC_Send_Tests is OTC_TestBase {
    ...
    function test_otcSend_rateLimitZero() external {
        vm.startPrank(Ethereum.SPARK_PROXY);
        mainnetController.setOTCBuffer(makeAddr("fake-exchange"), otcBuffer);
    ...
    function test_otcSend_lastSwapNotReturnedBoundary_noRecharge_usdt() external {
        ...
        deal(Ethereum.USDT, otcBuffer, 4_997_500e6 - 1);
        ...
        deal(Ethereum.USDT, otcBuffer, 1);
    ...
    function test_otcSend_lastSwapNotReturnedBoundary_noRecharge_usds() external {
        ...
        // 5m * 99.95% slippage = 4.9975m
        deal(Ethereum.USDS, otcBuffer, 4_997_500e18 - 1);
        ...
        deal(Ethereum.USDS, otcBuffer, 1);
    ...
    function test_otcSend_usdt() external {
        ...
        emit OTCLib.OTCSwapSent(exchange, otcBuffer, Ethereum.USDT, 10_000_000e6, 10_000_000e18);
    ...
    function test_otcSend_usds() external {
        ...
        vm.expectEmit(address(mainnetController));
        emit OTCLib.OTCSwapSent(exchange, otcBuffer, Ethereum.USDS, 10_000_000e18, 10_000_000e18);
...
contract MainnetController_OTC_Claim_Tests is OTC_TestBase {
    ...
    function test_otcClaim_transferFailed() external {
        ...
        deal(token, otcBuffer, 1_000_000e6);

        vm.prank(Ethereum.SPARK_PROXY);
        OTCBuffer(otcBuffer).approve(token, type(uint256).max);
    ...
    function test_otcClaim_usdt() external {
        deal(Ethereum.USDT, otcBuffer, 10_000_000e6);

        assertEq(USDT.balanceOf(almProxy),  0);
        assertEq(USDT.balanceOf(otcBuffer), 10_000_000e6);
        ...
        vm.expectEmit(address(mainnetController));
        emit OTCLib.OTCClaimed(exchange, otcBuffer, Ethereum.USDT, 10_000_000e6, 10_000_000e18);
        ...
        assertEq(USDT.balanceOf(almProxy),           10_000_000e6);
        assertEq(USDT.balanceOf(otcBuffer), 0);
    ...
    function test_otcClaim_usds() external {
        deal(Ethereum.USDS, otcBuffer, 10_000_000e18);

        assertEq(USDS.balanceOf(almProxy),  0);
        assertEq(USDS.balanceOf(otcBuffer), 10_000_000e18);
        ...
        vm.expectEmit(address(mainnetController));
        emit OTCLib.OTCClaimed(exchange, otcBuffer, Ethereum.USDS, 10_000_000e18, 10_000_000e18);
        ...
        assertEq(USDS.balanceOf(almProxy),  10_000_000e18);
        assertEq(USDS.balanceOf(otcBuffer), 0);
...
contract MainnetController_OTC_E2ETests is OTC_TestBase {
    ...
    function test_e2e_swapUSDTToUSDS() external {
        ...
        assertEq(USDS.balanceOf(otcBuffer), 9_980_000e18);
        assertEq(USDS.balanceOf(almProxy),  0);
        ...
        vm.expectEmit(address(mainnetController));
        emit OTCLib.OTCClaimed(exchange, otcBuffer, Ethereum.USDS, 9_980_000e18, 9_980_000e18);
        ...
        vm.expectEmit(address(mainnetController));
        emit OTCLib.OTCSwapSent(exchange, otcBuffer, Ethereum.USDS, 200_000e18, 200_000e18);
    ...
    function test_e2e_swapUSDSToUSDT() external {
        ...
        vm.prank(exchange);
        IERC20Like(Ethereum.USDT).transfer(otcBuffer, 9_980_000e6);

        assertEq(USDT.balanceOf(otcBuffer), 9_980_000e6);
        assertEq(USDT.balanceOf(almProxy),  0);
        ...
        vm.expectEmit(address(mainnetController));
        emit OTCLib.OTCClaimed(exchange, otcBuffer, Ethereum.USDT, 9_980_000e6, 9_980_000e18);
        ...
        vm.expectEmit(address(mainnetController));
        emit OTCLib.OTCSwapSent(exchange, otcBuffer, Ethereum.USDT, 200_000e6, 200_000e18);
...
contract MainnetController_OTC_GetClaimedWithRecharge_Tests is OTC_TestBase {
    ...
    function test_getOTCClaimedWithRecharge_test() external {
        ...
        vm.prank(exchange);
        USDS.transfer(otcBuffer, 5_500_000e18);
...
contract MainnetController_OTC_IsSwapReady_Tests is OTC_TestBase {
    ...
    function test_isOTCSwapReady() external {
        ...
        vm.prank(exchange);
        USDS.transfer(otcBuffer, 9_995_000e18 - 1);
