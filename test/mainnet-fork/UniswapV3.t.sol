...
abstract contract UniswapV3_TestBase is ForkTestBase {
    ...
    function setUp() public virtual override  {
        ...
        uniswapV3_UsdcUsdtPool_UsdcSwapKey = makeAddressAddressKey(
            ...
            Ethereum.USDC, UNISWAP_V3_USDC_USDT_POOL
        );

        uniswapV3_UsdcUsdtPool_UsdtSwapKey = makeAddressAddressKey(
            mainnetController.LIMIT_UNISWAP_V3_SWAP(),
            Ethereum.USDT, UNISWAP_V3_USDC_USDT_POOL
        );
        ...
        uniswapV3_DaiUsdcPool_DaiSwapKey = makeAddressAddressKey(
            mainnetController.LIMIT_UNISWAP_V3_SWAP(),
            Ethereum.DAI,  UNISWAP_V3_DAI_USDC_POOL
        );

        uniswapV3_DaiUsdcPool_UsdcSwapKey = makeAddressAddressKey(
            mainnetController.LIMIT_UNISWAP_V3_SWAP(),
            Ethereum.USDC, UNISWAP_V3_DAI_USDC_POOL
        );
...
contract MainnetController_UniswapV3_Swap_Tests is UniswapV3_TestBase {
    ...
    function test_swapUniswapV3_invalidTokenPair() external {
        uint256 amountIn = 100_000e6;
        deal(Ethereum.DAI, almProxy, amountIn);
...
contract MainnetController_UniswapV3_DAIUSDC_E2ETests is UniswapV3_E2ETestBase {
    ...
    function test_e2e_swapUniswapV3_DAIToUSDC(uint256 swapAmount) external {
        ...
        _e2eSwapUniswapV3(swapAmount, DAI, USDC, _getSwapKey(Ethereum.DAI));
    }
    ...
    function test_e2e_swapUniswapV3_DAIToUSDC_large(uint256 swapAmount) external {
        ...
        vm.startPrank(Ethereum.SPARK_PROXY);
        rateLimits.setRateLimitData(_getSwapKey(Ethereum.DAI), 2_000_000e18, uint256(2_000_000e18) / 1 days);
        vm.stopPrank();
    ...
    function test_e2e_swapUniswapV3_USDCToDAI(uint256 swapAmount) external {
        ...
        _e2eSwapUniswapV3(swapAmount, USDC, DAI, _getSwapKey(Ethereum.USDC));
    }
    ...
    function test_e2e_swapUniswapV3_USDCToDAI_large(uint256 swapAmount) external {
        ...
        vm.startPrank(Ethereum.SPARK_PROXY);
        rateLimits.setRateLimitData(_getSwapKey(Ethereum.USDC), 2_000_000e6, uint256(2_000_000e6) / 1 days);
        vm.stopPrank();
...
contract MainnetController_UniswapV3_USDCUSDT_E2ETests is UniswapV3_E2ETestBase {
    ...
    function test_e2e_swapUniswapV3_USDCToUSDT(uint256 swapAmount) external {
        ...
        _e2eSwapUniswapV3(swapAmount, USDC, USDT, _getSwapKey(Ethereum.USDC));
    }
    ...
    function test_e2e_swapUniswapV3_USDCToUSDT_large(uint256 swapAmount) external {
        ...
        vm.startPrank(Ethereum.SPARK_PROXY);
        rateLimits.setRateLimitData(_getSwapKey(Ethereum.USDC), 5_000_000e6, uint256(5_000_000e6) / 1 days);
        vm.stopPrank();
    ...
    function test_e2e_swapUniswapV3_USDTToUSDC(uint256 swapAmount) external {
        ...
        _e2eSwapUniswapV3(swapAmount, USDT, USDC, _getSwapKey(Ethereum.USDT));
    }
    ...
    function test_e2e_swapUniswapV3_USDTToUSDC_large(uint256 swapAmount) external {
        ...
        vm.startPrank(Ethereum.SPARK_PROXY);
        rateLimits.setRateLimitData(_getSwapKey(Ethereum.USDT), 5_000_000e6, uint256(5_000_000e6) / 1 days);
        vm.stopPrank();
...
contract MainnetController_UniswapV3_AddLiquidity_FailureTests is UniswapV3_TestBase {
    ...
    function _defaultDesiredPosition() internal view returns (UniswapV3Lib.TokenAmounts memory) {
        ...
        uint256 amount1 = 1000 * 10 ** uint256(token1.decimals());
...
contract MainnetController_UniswapV3_Swap_SandwichAttackTest is UniswapV3_TestBase {
    ...
    function test_uniswapV3_sandwichRisk_withoutTWAP() external {
        ...
        deal(Ethereum.USDC, address(this), attackerInitialUsdc);
        USDC.approve(UNISWAP_V3_ROUTER, attackerInitialUsdc);

        ISwapRouter.ExactInputSingleParams memory frontParams = ISwapRouter.ExactInputSingleParams({
            tokenIn           : Ethereum.USDC,
            tokenOut          : Ethereum.DAI,
            fee               : fee,
        ...
        deal(Ethereum.USDC, almProxy, victimAmountIn);
