...
contract RateLimits_Tests is UnitTests {
    ...
    /**********************************************************************************************/
    /*** setRateLimitData 5 args tests                                                          ***/
    /**********************************************************************************************/

    function test_setRateLimitData_5_args_unauthorizedAccount() external {
    ...
    function test_setRateLimitData_5_args_invalidLastUpdated_boundary() external {
        vm.startPrank(admin);
    ...
    function test_setRateLimitData_5_args_invalidAmount_boundary() external {
        vm.startPrank(admin);
    ...
    function test_setRateLimitData_5_args() external {
    ...
    /**********************************************************************************************/
    /*** setRateLimitData 3 args tests                                                          ***/
    /**********************************************************************************************/

    function test_setRateLimitData_3_args_unauthorizedAccount() external {
        vm.expectRevert(abi.encodeWithSignature(
            "AccessControlUnauthorizedAccount(address,bytes32)",
            address(this),
            DEFAULT_ADMIN_ROLE
    ...
    function test_setRateLimitData_3_args() external {
        vm.expectEmit(address(rateLimits));
        emit RateLimitDataSet(TEST_KEY1, 1000, 10, 1000, block.timestamp);
        vm.prank(admin);
        rateLimits.setRateLimitData(TEST_KEY1, 1000, 10);
    ...
    /**********************************************************************************************/
    /*** setUnlimitedRateLimitData tests                                                        ***/
    /**********************************************************************************************/
    ...
    /**********************************************************************************************/
    /*** triggerRateLimitDecrease tests                                                         ***/
    /**********************************************************************************************/
    ...
    /**********************************************************************************************/
    /*** triggerRateLimitIncrease tests                                                         ***/
    /**********************************************************************************************/
